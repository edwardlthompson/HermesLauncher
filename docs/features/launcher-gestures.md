...
- ✅ User-visible behavior: swipe up/down map to drawer, search, lock, torch, shade; defaults swipe down = search, swipe up = All Apps; gesture picker in Settings; Home-again and double-tap stay
