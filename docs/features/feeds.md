...
- Article tap opens the launcher reading-mode view (or the system browser); Close / Back returns to the list
- Android Authority (`https://www.androidauthority.com/feed/`) is seeded once via `DefaultFeeds`
