...
|-------|-----------|---------|-------|
| Platform | Multi-stack template (Web, Python, Android, Node, optional Lightroom/Rust/Go) | 0.18.0 | Template maintainer repo |
...
- **Template version:** `0.18.0` (see `.template-version`)
