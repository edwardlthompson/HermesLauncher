...
|-------|-----------|---------|-------|
| Platform | Multi-stack template (Web, Python, Android, Node, optional Lightroom/Rust/Go) | 0.15.2 | Template maintainer repo |
...
- **Template version:** `0.15.2` (see `.template-version`)
