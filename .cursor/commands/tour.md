...
1. Read @docs/START_HERE.md — name the repo mode (Bootstrap vs Reference) and point at `docs/AGENT_PORTABILITY.md` (one sentence: edit `AGENTS.md`, then re-sync adapters).
