...
![Template](https://img.shields.io/badge/template-0.18.2-0969da?style=flat-square)
...
Current template version: **0.18.2** (see `.template-version`, Release Please, and `scripts/pre-release-gate.sh`).
