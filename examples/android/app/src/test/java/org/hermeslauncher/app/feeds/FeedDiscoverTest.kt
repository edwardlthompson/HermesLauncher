...
class FeedDiscoverTest {
    ...
    @Test
    fun guessesWordpressFeedPath() {
        assertEquals(
            listOf(
                "https://www.androidauthority.com/feed/",
                "https://www.androidauthority.com/rss",
                "https://www.androidauthority.com/atom.xml",
            ),
            FeedDiscover.guesses("https://www.androidauthority.com/"),
        )
        assertEquals(
            "https://www.androidauthority.com/feed/",
            FeedDiscover.canonicalize("https://www.androidauthority.com/feed"),
        )
    }
}
