...
class FolderLidTest {
    ...
    @Test
    fun previewCapMatchesKind() {
        assertEquals(1, FolderLid.previewCap(FolderPreviewKind.STACK))
        assertEquals(3, FolderLid.previewCap(FolderPreviewKind.FAN))
        assertEquals(4, FolderLid.previewCap(FolderPreviewKind.GRID))
    }
