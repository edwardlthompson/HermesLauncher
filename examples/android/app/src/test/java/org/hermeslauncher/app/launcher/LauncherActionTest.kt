...
class LauncherActionTest {
    ...
    @Test
    fun drawerAndSearchOpenAppsOthersAreInstant() {
        assertEquals(true, LauncherAction.DRAWER.opensApps())
        assertEquals(true, LauncherAction.SEARCH.opensApps())
        assertEquals(false, LauncherAction.LOCK.opensApps())
        assertEquals(true, LauncherAction.LOCK.isInstant())
        assertEquals(true, LauncherAction.FLASHLIGHT.isInstant())
        assertEquals(true, LauncherAction.SHADE.isInstant())
        assertEquals(false, LauncherAction.DRAWER.isInstant())
    }
}
