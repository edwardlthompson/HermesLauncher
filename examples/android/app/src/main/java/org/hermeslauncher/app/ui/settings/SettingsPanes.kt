...
@Composable
fun SettingsStubPane(section: SettingsSection) {
    Column(verticalArrangement = Arrangement.spacedBy(SpacingMd)) {
        Text(text = stringResource(section.titleRes()), style = MaterialTheme.typography.titleMedium)
        Text(text = stringResource(section.bodyRes()), style = MaterialTheme.typography.bodySmall)
    }
}
