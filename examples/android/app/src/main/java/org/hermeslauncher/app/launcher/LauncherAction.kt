...
fun LauncherAction.opensApps(): Boolean = this == LauncherAction.DRAWER || this == LauncherAction.SEARCH

fun LauncherAction.isInstant(): Boolean =
    this == LauncherAction.LOCK || this == LauncherAction.FLASHLIGHT || this == LauncherAction.SHADE
