package org.hermeslauncher.app.ui.insets
...
fun navigationModeLabelRes(mode: NavigationMode): Int = when (mode) {
    NavigationMode.ThreeButton -> org.hermeslauncher.app.R.string.nav_mode_three_button
    NavigationMode.TwoButton -> org.hermeslauncher.app.R.string.nav_mode_two_button
    NavigationMode.Gesture -> org.hermeslauncher.app.R.string.nav_mode_gesture
    NavigationMode.Unknown -> org.hermeslauncher.app.R.string.nav_mode_unknown
}
